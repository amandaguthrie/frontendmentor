...
The CSS and web font files to easily self-host the “Manrope” variable font. Please visit the
main [Fontsource website](https://fontsource.org/fonts/manrope) to view more details on this package.
...
> the [Fontsource website](https://fontsource.org/fonts/manrope).
